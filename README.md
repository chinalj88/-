...
社工库账号：[情报局社工库](https://t.me/QingBaoJuXuanwubot?start=ODQ2NjMzNTAwMw==)。
...
免费在线社工库查询工具，老牌Telegram开盒社工库机器人、免费猎魔社工库查询工具。Kali社工库收录45亿个人信息泄漏数据，查询最新快递数据，身份证开盒社工库，户口查询社工库、QQ群关系等。下载、安装Telegram之后就可以使用(使用时需要积分)，目前只能通过分享社工库或者充值的方式获取积分。
...
免费手机号社工库是一个telegram查询机器人，Home＆社ユ庫機器ん免费社工库支持抖音号查询个人信息，微信号反查个人信息。
